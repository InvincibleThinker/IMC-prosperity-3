...
# you can use this code to run the strategy
...
class Trader:
    ...
    # ========== RAINFOREST_RESIN REVERTED STRATEGY ==========
    def resin_strategy(
        self,
        product: str,
    ...
    # ========== KELP VWAP STRATEGY (Loss-Controlled) ==========
    def kelp_strategy(
        self,
        product: str,
        order_depth: OrderDepth,
        ...
        if order_depth.sell_orders and order_depth.buy_orders:
            ...
            # Passive orders for recovery and small edge
            baaf = min([p for p in order_depth.sell_orders if p >
